 ...
 */
describe('attendeeProfileProxy(attendees, profileService,prefetchLimit)',function(){
  'use strict';
  ...
  describe('초기화', function () {
    it('prefetchLimit가 양수가 아니면 프로필을 전혀 선취하지 않는다', function() {
      ...
      notPositiveNumbers.forEach(function(perfetchLimit){
        proxy(attendees,profileService,perfetchLimit);
      });
