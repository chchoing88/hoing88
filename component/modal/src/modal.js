...
A.ui.ModalMaster.prototype = {
  ...
  _eventBinding: function (target) {
    ...
    var closeBtn = closedimmed.querySelector(modal.closeBtnSelector);
    var contentsModal = closedimmed.querySelector(modal.contentsSelector);
    ...
    function eventDel(){
      ...
      contentsModal.removeEventListener('mousedown',dragInit,false);
      contentsModal.removeEventListener('mousemove',dragMove,false);
      contentsModal.removeEventListener('mouseup',dragEnd,false);
    }

    closeBtn.addEventListener('click',remove,false);
    closedimmed.addEventListener('click',remove,false);

    contentsModal.addEventListener("mousedown", dragInit, false);
    contentsModal.addEventListener("mousemove",dragMove , false);
    contentsModal.addEventListener("mouseup", dragEnd,false)
